...
- **NIMBY**. Neighbors may oppose projects despite the need for biomass utilization, forest products, and mills. For example, Alpenglow Timber in Truckee, California, in late 2024, faced a NIMBY challenge even though some opponents were on biomass promotion projects or boards!
...
- **One size doesn't fit all**. This creates a conundrum that prevents scaling, since every effort to scale requires bespoke changes in policy, funding, workforce, behavior, and institutions [@churches]. Furthermore, some companies may be content to scale to a certain size; others may wish to grow further. The organization's board can factor this right size into planning, but bottom-up ownership of this growth also needs attention, not just top-down direction from the board.
- **Effectiveness & scalability**. Evidence of scaling effectiveness, readiness, and risk evaluation can be lacking in projects. Total impact depends on more than scalability; it is the sum of effectiveness and scale [@pienkowski].
