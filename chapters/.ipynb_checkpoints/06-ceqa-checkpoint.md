...
abstract: |
  Environmental compliance can range from simple to complex, costing nominal amounts to ‘a lot’. If you haven't started on compliance, we offer pathways and ideas to get you started. This chapter outlines key routes for meeting CEQA (and sometimes NEPA) requirements, with a decision-making flowchart and practical guidance tailored to forest health and wood products projects.
kernelspec:
    name: python3
...
Compliance with the California Environmental Quality Act (CEQA) and the National Environmental Protection Act (NEPA) is required for all planned projects. Projects on federal lands require NEPA; all other projects require CEQA. However, most California state-funded projects may require CEQA regardless of project location. The CEQA Handbook for Bioenergy and Wood Products Businesses is a useful reference guide for project developers, local government, and business owners [@ceqaclere]

# CEQA
A general flowchart showing the decision-making process for the California Environmental Quality Act (CEQA) for any project on nonfederal land in California ({numref}`ceqa1`). This flowchart is a general CEQA process for any project requiring CEQA compliance. For forest health and wood products projects, use the diagram as an overall environmental frame of reference rather than the exact process for obtaining compliance for your project.
