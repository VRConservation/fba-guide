...
subject: Closeout
subtitle: How to learn, leverage, and close out a grant project
...
Grant closeout begins well before your agreement termination date ({numref}`close-graphic`). The hypothetical timeline of approximately three months to complete closeout applies to CALFIRE and other grants, dependent on grant terms.
...
For example, you may want to tie results from the project into your annual report or a blog post on LinkedIn describing what you learned from the funding and the project. Use this opportunity to consider ways to thank your funder(s) and interact with them to secure further funding (if needed). 
