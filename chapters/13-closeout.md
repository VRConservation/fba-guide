...
2. Closeout includes complete key processes required by your grant agreement and institution. Make sure to start grant closeout well ahead of the end of your grant.
3. For CALFIRE grants, closeout involves both financial and project report as well as completing forms sent to you by CALFIRE and on eCivis.
...
Grant closeout is a process initiated well before your agreement termination date ({numref}`close-graphic`). The hypothetical timeline of approximately three months to complete closeout applies to CALFIRE and other grants, dependent on grant terms.
...
For example, you may want to tie results from the project into your annual report or a blog post on LinkedIn describing what you learned from the funding and the project. Use this as an opportunity to consider ways to thank your funder(s) and to interact with them to secure further funding (if needed). 

One month prior to the grant's end, analyze and process financial information. Don't leave this until the last minute, as it takes time, and you don't want to be combing through a mountain of receipts and other expenses at the last minute. You can always add expenses as you close out, but doing fewer at a time is easier.
...
4. **Visualize**. Think of creative ways to visualize and convey your results beyond words in a paragraph (within bounds of agreement and reporting requirements). Graphs, maps, and photos all help communicate your message and the accomplishments of the project.
