---
title: Reviving Sonoma's Timbershed
subject: Cases
subtitle: Forestree Collective's circular model for resilient forests and stronger rural economies
short_title: Forestree Collective
date: 2026-01-27
authors:
...
license: CC-BY-4.0
keywords: Startup, sawmill, community, economic development
abstract: |
  Fire-prone forests present significant challenges, including high restoration costs, limited processing infrastructure, and restrictive regulations that hinder ecological restoration efforts. In response to these issues, Forestree Collective has developed a pioneering circular, market-based approach to forest restoration. Their vertically integrated model connects forest health with wood product innovation, enabling the transformation of restoration byproducts into high-value furniture and mass timber. This approach not only creates local jobs and revitalizes essential wood-processing infrastructure but also relies on strong partnerships with universities, nonprofits, and public agencies to advance research and navigate policy hurdles. Key lessons from Forestree's experience underscore the importance of holistic, closed-loop systems, collaborative efforts, visible demonstration projects, and advocating for regulatory flexibility. Ultimately, their work illustrates that restoration-driven enterprises can align rural economies with ecological health, offering a replicable model for fostering wildfire resilience and promoting sustainable development.
...
- **Leverage Partnerships**: Collaboration with universities, nonprofits, and public agencies can accelerate innovation and help overcome technical and financial barriers. Research partnerships validate performance, while grants and local alliances provide credibility and resources.
...
# Reviving the mill
Forestree Collective’s mill in Sebastopol, CA, and woodshop in Penngrove, CA, create a circular, market-based approach to forest restoration ({numref}`shop`). The 172-acre historic mill property has been upgraded to include a Woodlandia 200XP single-pass log ripper to process small-diameter logs, a Woodmizer LT-40 Wide portable bandsaw mill for larger logs, and a compact telehandler. Forestree also has a fully equipped 5,000-square-foot woodshop for secondary wood products manufacturing, including a kiln drying operation with a solar kiln built from their own mass timber product, nail-laminated timber (NLT), and a dehumidification kiln. Shop equipment includes table saws, jointers, planers, panel saw, bandsaw, shaper, and a wide belt sander. 

:::{figure} ../../figures/ft/log.jpg
:name: log
:height: 400px
A log harvested during restoration at Forestree Collective’s mill in Sebastopol, California.
:::

Forestree’s vertically integrated process functions as a closed-loop system. Small-diameter trees (6 inches and larger)—responsibly sourced through partnerships with local landowners and foresters—are milled in-house, solar-kiln-dried, and transformed into value-added products in the woodshop ({numref}`log`). Each stage of production builds on the one before it: restoration yields raw material; milling produces dimensional lumber; the woodshop converts that lumber into finished goods. This integrated flow ensures consistent quality, reduces waste and energy use, and provides a reliable supply chain for climate-smart materials.

# Restoration by design
Forestree Collective is redefining how restoration wood moves through the value chain by linking forest health directly to wood products innovation. Through a fully circular model, small-diameter and underutilized logs removed during thinning and fuel-reduction projects are transformed into durable, high-value products that extend the material's life, lock carbon into long-lived form, and create new incentives for stewardship ({numref}`table`). Forestree is currently advancing two complementary product lines—climate-smart furniture and custom interiors, and an innovative mass Nail-Laminated Timber (NLT) system, each expanding the circular model and opening new markets for regenerative, restoration-driven wood products.

:::{figure} ../../figures/ft/table.jpg
:name: table
:height: 400px
Forestree’s Sonoma Table is a modern take on the classic trestle table with the rounded corners for a contemporary look.
:::

**Climate-smart furniture and custom interiors** are Forestree Collective’s first expression of its circular, restoration-driven approach to material innovation. Restoration-grade material from fuel-reduction and forest health projects is turned into high-quality furniture and architectural elements for commercial and residential spaces. 
...
:name: kiln
:height: 400px
Forestree's NLT solar kiln.
:::

Current R&D focuses on using locally sourced, non-merchantable timber—milled and kiln-dried by Forestree—then assembled into prototype panels for testing. Dr. Paul Mayencourt of the Berkeley Wood Lab is working with Forestree Collective to help balance cost, ecological value, and carbon benefits—for example, by strategically intermixing species, grades, and dimensions to maximize use of lower‑grade material while meeting performance requirements. Regenerative Forest Solutions conducted a feasibility study that Forestree is using to inform the procurement of material for its primary and secondary wood products.

# Partnerships
Forestree Collective’s collaboration with public agencies, academic institutions, nonprofit organizations, and local communities has been a major driver of its early success. The company’s first success was winning the Sonoma County Bio Business competition in 2021, which helped launch the business, elevated its profile, and provided financial and technical resources.

The California Department of Forestry and Fire Protection (CAL FIRE) and the U.S. Forest Service (USFS) have recognized and supported Forestree’s innovative work with grants that have helped Forestree expand its milling and manufacturing capacity and enabled it to pilot its NLT building system.
...
A central impact of Forestree’s work is the revival of wood-products infrastructure in Sonoma County ({numref}`interior`). Forestree Collective and Regenerative Forest Solutions have recently launched Timbershed, a public-private partnership that intends to reopen a mothballed mill and transform it into a flagship wood products campus for Sonoma County, with the capacity to process up to six million board feet (MMbf) of timber each year. 

:::{figure} ../../figures/ft/interior.jpg
:name: interior
:height: 400px
...
# Credits
We commend the innovation and leadership of [Forestree Collective](https://www.forestreecollective.com/) for advancing a practical, circular model that transforms restoration‑grade timber into high‑value, climate‑smart products while strengthening forest health, rural economies, and wildfire resilience. A special thanks to Regenerative Forest Solutions for contributing to this article. We also extend our deep gratitude to [CALFIRE](https://www.fire.ca.gov/) for funding the Forest Business Alliance’s work with Forestree Collective, and other community forestry partners across California. Rural and Tribal communities engaged in the forest products sector can benefit from resources such as the [Forest Business Guidebook](https://3point.xyz/fba-guide/), the Forest Business Alliance [website](https://www.forestbusinessalliance.org/), and [workshops](https://www.forestbusinessalliance.org/workshops), including the Early Stage Project Development workshop.

Photos courtesy of Forestree Collective.
